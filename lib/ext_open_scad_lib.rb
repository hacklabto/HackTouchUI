module ExtOpenScad
  def self.compile!(scad_script)
    ...
    begin
      ...
      hs_lib = File.expand_path( File.join Padrino.root, "lib", "hs", "ImplicitExportJS.hs" )
      ...
      return {format: "THREE.Geometry", data: response_data, stdout: (stdout.gets || ""), stderr: (stderr.gets || "")}.to_json
